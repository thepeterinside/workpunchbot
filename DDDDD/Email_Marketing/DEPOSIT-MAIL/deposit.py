...
while True:
    raw_amount = input("Please provide the deposited amount (e.g. 1234.56 or $1,234.56): ").strip()
    try:
...
with open(r"D:\DDDDD\Email_Marketing\DEPOSIT-MAIL\index.html", "r", encoding="utf-8") as file:
